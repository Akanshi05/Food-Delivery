  ...
  return (
    <div className='container mt-4'>
        <main>
          ...
          <img className='d-block mx-auto' src={assets.logo} alt="" width="98" height="98"></img>
          </div>
        ...
        <form className="needs-validation" onSubmit={onSubmitHandler}>
          <div className="row g-3">
            ...
            <div className="col-sm-6">
              ...
              <input type="text" className="form-control" id="lastName" placeholder="" required name="lastName" onChange={onChangeHandler} value={data.lastName}/>
            </div>
            ...
            <div className="col-12">
              ...
              name="phoneNumber" value={data.phoneNumber} onChange={onChangeHandler}/>
            </div>

            <div className="col-12">
              <label htmlFor="address" className="form-label">Address</label>
              <input type="text" className="form-control" id="address" placeholder="1234 Main St" required
              name="address" value={data.address} onChange={onChangeHandler}/>
            </div>
            ...
            <div className="col-md-3">
              ...
              <input type="number" className="form-control" id="zip" placeholder="110023" required
