...
import { fetchFoodDetails, getProductImageUrl } from '../../service/foodService';
    ...
    <section className="py-5">
            <div className="container px-4 px-lg-5 my-5">
                <div className="row gx-4 gx-lg-5 align-items-center">
                    <div className="col-md-6"><img className="card-img-top mb-5 mb-md-0" src={getProductImageUrl(data.imageName)} alt="..." /></div>
