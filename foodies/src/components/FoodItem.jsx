...
import { getProductImageUrl } from '../service/foodService';
import { Link } from 'react-router-dom';
import { StoreContext } from '../context/StoreContext';



const FoodItem = ({name,description,id,imageName,price}) => {
  ...
  return (
    <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex justify-content-center">
            <div className="card" style={{"maxWidth": "320px"}}>
              <Link to={`/food/${id}`} >
               <img src={getProductImageUrl(imageName)} className="card-img-top" alt="Product Image" height={300} width={60}/>
               </Link>
